...
<head>
  ...
  <link href="https://faviconka.ru/ico/1/faviconka.ru_1_103888.ico" rel="icon">
</head>
...
<body>
      ...
      <div id="user_form" class="cal-12 mx-auto">
        ...
        <form action="." method="POST">
          ...
          <div class="submitStyle">
            Биография:
            <textarea name="bio">ЧТО?КТО?</textarea>
          </div>
  ...
  <footer class="foot">
    <div id=contacts>
      <h4>student of KUBSU 25<a href="5/solo.html">/</a>2</h4>
    </div>
  </footer>
</body>
